      ...
      >
        ...
        >
          <img
            ...
            src={
              user?.profilePicUrl?.url ? user?.profilePicUrl?.url : NoUserUrl
            }
            alt='user'
          />
        </Box>
        ...
        <Box sx={{ py: 1 }}>
          <Stack spacing={1}>
            <Link className='link' to='/'>
              <Typography sx={{ fontSize: 12, ':hover': { color: '#EE960A' } }}>
                Home
              </Typography>
            </Link>
            ...
            <Link className='link' to='/settings/personal-information'>
              <Typography sx={{ fontSize: 12, ':hover': { color: '#EE960A' } }}>
                Settings
              </Typography>
            </Link>
    ...
    >
      ...
      {user ? (
        <Box sx={{ px: 1 }}>
          ...
          <MenuItem onClick={() => history.push('/my-jobs')}>
            <IconButton size='large' color='inherit'>
              <WorkOutlinedIcon />
            </IconButton>
            <p>Jobs</p>
          ...
          <Toolbar>
            <Link to='/dashboard' style={{ textDecoration: 'none' }}>
              <Box sx={{ display: 'flex', alignItems: 'end' }}>
                ...
                <Typography variant='h6' sx={{ pl: 1, color: '#7AB259' }}>
                  SELL CENTER
                </Typography>
              </Box>
            </Link>
            ...
            <Box sx={{ display: { xs: 'none', md: 'flex' } }}>
              {user ? (
                <Box sx={{ display: 'flex' }}>
                  ...
                  >
                    <HomeIcon />
                    <Typography variant='subtitle2'>My Shop</Typography>
                  </IconButton> */}
